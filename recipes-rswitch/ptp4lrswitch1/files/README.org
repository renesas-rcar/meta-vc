...
* Introduction
  ...
  RENESAS: Additions to the code to implement Transparent Clock support
...
* Features
  ...
  - Implements Boundary Clock (BC) and Ordinary Clock (OC) and Transparent Clock(TC).
...
** PTP stack
   ...
   1. Just type 'make', or 'make -f makefile.ravbsw'
