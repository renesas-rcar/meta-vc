#!/bin/sh
#
#Generic Boot script for the VC
#This file shall be copied to /etc/init.d and is not intended to be edited.
#Use "update-rc.d -f vc-startup.sh defaults" to register this file for startup
#
...
echo "VC environment start"
path=/home/root/vc/booting
