...
#disable the broadcast on KSZ8091 (bit9)
    n=5
...
#---------------------------------------------------------------------------------
    ...
    /home/root/vc2/misc/writeRTL9010.sh 0
    /home/root/vc2/misc/writeRTL9010.sh 1
    /home/root/vc2/misc/writeRTL9010.sh 2
    /home/root/vc2/misc/writeRTL9010.sh 3

    # setting Ethenet agent 0 to 3 in RGMII mode
    # change Ethernet agent to config mode
    # change RMAC in RGMII
    # change Ethernet agent to operation mode
#    devmem 0xC9058000 32 0x2
#    devmem 0xC905B814 32 0x01130007
#    devmem 0xC9058000 32 0x3
#    devmem 0xC905C000 32 0x2
#    devmem 0xC905F814 32 0x01130007
#    devmem 0xC905C000 32 0x3
#    devmem 0xC9060000 32 0x2
#    devmem 0xC9063814 32 0x01130007
#    devmem 0xC9060000 32 0x3
#    devmem 0xC9064000 32 0x2
#    devmem 0xC9067814 32 0x01130007
#    devmem 0xC9064000 32 0x3
